...
import model.{PostId, PostSecret, PostSecretGenerator, Topic, TopicId, User}
...
class NotEmptyRouteRepositoryMockSpec
  ...
  s"Routes with validations with repository mocks" should {
